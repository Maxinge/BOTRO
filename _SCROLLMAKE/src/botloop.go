...
func botLoop() {
    ...
    for {
        ...
        _,scroll := itemInInventory(7433,1)
        _,tail := itemInInventory(904,3) // [82 47 0 0] // fire
        _,snail := itemInInventory(946,3) // [83 47 0 0] // water
        _,horn := itemInInventory(947,3) // [84 47 0 0] // earth
        _,rainbow := itemInInventory(1013,3) // [85 47 0 0] // wind
